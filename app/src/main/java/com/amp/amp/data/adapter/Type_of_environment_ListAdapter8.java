...
public class Type_of_environment_ListAdapter8 extends ListAdapter<Type_of_environment, Type_of_environment_ViewHolder> {
    public Type_of_environment_ListAdapter8(@NonNull DiffUtil.ItemCallback<Type_of_environment> diffCallback) {
        super(diffCallback);
    }

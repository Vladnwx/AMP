...
public class Type_of_environment_ListAdapter extends ListAdapter<Type_of_environment, Type_of_environment_ViewHolder> {
    public Type_of_environment_ListAdapter(@NonNull DiffUtil.ItemCallback<Type_of_environment> diffCallback) {
        super(diffCallback);
    }
    ...
    static class WordDiff extends DiffUtil.ItemCallback<Type_of_environment> {
